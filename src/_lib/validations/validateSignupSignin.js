...
export const registerFormSchema = z.object({
   ...
   pword: z
      ...
      .regex(/[a-zA-Z]/, { message: "Password must contain at least one uppercase and lowercase letter" })
...
export const signinSchema = z.object({
   email: z.string().trim().min(2, { message: "Email address is required" }).email({ message: "Invalid email format" }),

...
//           <h3 style={{ fontFamily: "Playfair Display, serif", fontSize: "17px", fontWeight: "700", color: "#2C1A0E", marginBottom: "4px" }}>{provider.business_name || provider.fname}</h3>
//           <p style={{ color: "#8B5E3C", fontSize: "13px", marginBottom: "10px" }}>📍 {provider.address}</p>
//           {/* <p style={{ color: "#5C3D1E", fontSize: "13px", lineHeight: "1.5", marginBottom: "16px" }}>{provider.hot}</p> */}
...
//             </div>
//             <span style={{ fontSize: "12px", color: "#6A9B5F", fontWeight: "500" }}>{provider.response_time}</span>
//           </div>
//         </div>
//       </div>
//     </Link>

...
export default function StoragePage({ storage, error }) {
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-white dark:from-[#1b1a19] dark:to-[#1b1a19]">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
               <div className="text-center">
                  ...
                  <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
                     Preserve your harvest with state-of-the-art storage solutions designed for modern agriculture
                  </p>
                  <div className="flex gap-4 justify-center">
                     ...
                     >
                        ...
                        Book Storage <ArrowRight size={20} />
                     </Link>
         ...
         <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-12">
               <h2 className="text-4xl font-bold text-gray-800 dark:text-foreground mb-4">Our Storage Solutions</h2>
               <p className="text-gray-600 dark:text-gray-50 text-lg">
                  Choose the perfect storage environment for your agricultural products
               </p>
            </div>
         ...
         <section className="py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               <div className="text-center mb-12">
                  <h2 className="text-4xl font-bold text-gray-800 mb-4">Start booking for your storage</h2>
                  <p className="text-gray-600 text-lg">Choose a storage facility that fits your storage needs</p>
               </div>
               ...
               <div className="grid md:grid-cols-3 gap-2">
                  {error ? (
                     ...
                     storage?.length > 0 &&
                     storage?.map((st, idx) => (
                        <Card key={idx} className="p-2 text-start">
                           <div className="">
                              <Image
                           ...
                           <div className="mb-6 flex justify-between items-center rounded p-2 bg-gray-300">
                              <span className="text-lg font-semibold">
                                 {formatPrice(st.price, st.country_code, st.currency)} / Per MT
                              </span>
                              <Link href={`/storage/${st.href}`} className="flex items-center">
         ...
         <section className="bg-gradient-to-r from-green-600 to-green-700 text-white py-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
               ...
               <p className="text-xl text-green-100 mb-8">Join hundreds of business owners who trust our facilities</p>
         ...
         <footer className="bg-gray-800 text-white py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
               <p className="text-gray-400">© 2026 Agro Storage Platform. All rights reserved.</p>
            </div>
         </footer>
      </div>
   );

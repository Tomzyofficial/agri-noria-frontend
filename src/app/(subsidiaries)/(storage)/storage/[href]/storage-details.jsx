...
import { ArrowRight, Check, MapPin, Clock, Shield, Thermometer, BarChart3, Phone } from "lucide-react";
import Link from "next/link";
import { Button } from "@/components/ui/Button";
import { Modal } from "@/components/ui/Modal";
import { useState } from "react";
import BookingsForm from "@/app/(subsidiaries)/components/BookingsForm";
      ...
      return (
         <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="text-center">
               <h1 className="text-3xl font-bold text-gray-800 mb-4">Storage Not Found</h1>
               <p className="text-gray-600 mb-6">{error || "The requested storage space could not be found."}</p>
               <Link href="/storage" className="text-green-600 hover:underline font-medium">
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-(--card-dark)">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="w-full md:w-1/2 mb-8 md:mb-0">
                     ...
                     <p className="text-xl text-neutral-700 mb-6">{storage.description}</p>
                     <div className="flex items-center text-2xl font-bold mb-6">
                        {formatPrice(storage.price, storage.country_code, storage.currency)}
                     ...
                     >
                        <BookingsForm onClose={() => setOpenModal(false)} storageName={storage.storage_name} />
                     </Modal>
                  </div>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid md:grid-cols-2 gap-12">
               <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Storage Details</h2>
                  <ul className="space-y-4">
                     {storage.temperature && (
                        <li className="flex items-start">
                           ...
                           <span className="text-gray-700">Temperature: {storage.temperature}</span>
                        </li>
                     )}
                     {storage.storage_type && (
                        <li className="flex items-start">
                           ...
                           <span className="text-gray-700">Type: {storage.storage_type}</span>
                        </li>
                     )}
                     ...
                     {storage.capacity && (
                        <li className="flex items-start">
                           ...
                           <span className="text-gray-700">Total Capacity: {storage.capacity} MT</span>
                        </li>
                     )}
                     {storage.available && (
                        <li className="flex items-start">
                           ...
                           <span className="text-gray-700">Available: {storage.available} MT</span>
                        </li>
                     )}
                  </ul>
               </div>
               ...
               <div className="bg-white p-6 rounded-xl shadow-md">
                  ...
                  {features.length > 0 ? (
                     ...
                     <p className="text-gray-600">No features listed for this storage facility.</p>
                  )}

                  {storage.vendor_id && (
                     <div className="mt-8 p-4 bg-green-50 rounded-lg">
                        <h4 className="font-medium text-green-800 mb-2">Vendor Information</h4>
                        {/* {
                  ...
                  <div className="mt-8 p-4 bg-green-50 rounded-lg">
                     <h4 className="font-medium text-green-800 mb-2">Need Help Deciding?</h4>
                     <p className="text-sm text-green-700 mb-4">
                        Our storage experts are available to help you choose the perfect storage solution for your
                        needs.
                     </p>
                     <a
         ...
         <div className="bg-green-50 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
               ...
               <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                  Reserve your storage space today and experience premium agricultural storage solutions.
               </p>

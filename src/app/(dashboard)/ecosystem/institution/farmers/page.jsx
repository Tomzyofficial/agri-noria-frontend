                  ...
                  {filteredData.length === 0 ? (
                    ...
                    filteredData.map((farmer, idx) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          {farmer.program_name ? (
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300 border border-indigo-200/50 dark:border-indigo-500/20">
                              {farmer.program_name}
                            </span>
                          ) : (

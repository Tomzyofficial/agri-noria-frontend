...
export default function EnrolledProgramsPage() {
  ...
  if (loading)
    return (
      <div className="p-8 text-center animate-pulse font-black text-gray-400">
        Loading Programs...
      </div>
    );
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500 font-bold uppercase tracking-widest mt-1">
          Manage your active agricultural program participation
        </p>
      </div>
      ...
      {profile?.program_id ? (
          ...
          <CardContent className="p-10">
              ...
              <ProgramStat
                ...
                value={
                  profile.program_end_date
                    ? new Date(profile.program_end_date).toLocaleDateString(
                        "en-GB",
                        { day: "numeric", month: "short", year: "numeric" },
                      )
                    : "—"
            ...
            <div className="mt-12 p-8 bg-gray-50 dark:bg-gray-900/50 rounded-3xl border border-gray-100 dark:border-gray-800">
              ...
              <p className="text-gray-500 font-medium leading-relaxed">
                This program aims to boost local productivity through
                high-quality input financing and modern agronomic training. As
                an enrolled farmer, you are eligible for the input request cycle
                and full-season technical support from our field operations
                team.
              </p>
            </div>
          </CardContent>
        ...
        <Card className="border-none shadow-xl bg-white dark:bg-gray-950 rounded-3xl p-16 text-center">
          ...
          <p className="text-gray-400 font-bold uppercase tracking-widest text-xs mb-8">
            You haven't joined an agricultural program yet
          </p>
          <a
            href="/ecosystem/farmer"
            className="inline-block bg-green-600 hover:bg-green-700 text-white font-black px-10 py-5 rounded-2xl shadow-xl shadow-green-500/20 transition-all hover:scale-105 uppercase tracking-widest text-xs"
          >

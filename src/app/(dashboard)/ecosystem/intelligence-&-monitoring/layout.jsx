...
export default function IntelligenceLayout({ children }) {
  ...
  const sidebarNavMenu = [
    {
      label: "Overview",
      href: "/ecosystem/intelligence-&-monitoring",
      icon: <LayoutDashboard className="w-4 h-4" />,
    },
    {
      label: "Surveillance",
      href: "/ecosystem/intelligence-&-monitoring/surveillance",
      icon: <Satellite className="w-4 h-4" />,
    },
    {
      label: "Field Audits",
      href: "/ecosystem/intelligence-&-monitoring/field-audits",
    ...
    {
      label: "Settings",
      href: "/ecosystem/intelligence-&-monitoring/settings",
      ...
      <aside>
        ...
        >
          <div className="mb-8 px-2">
            <h2 className="text-xl font-black text-purple-600 tracking-tighter uppercase">
              AgriNoria
            </h2>

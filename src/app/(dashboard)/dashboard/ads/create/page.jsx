...
import { createCampaign } from "@/not-in-useyet-lib/adsApi";
    ...
    <div className="mx-auto max-w-xl space-y-8">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
          Budget is charged in full via Paystack. Use the UUID of your listing,
          training, or your vendor id for featured vendor placements.
        </p>
      </div>

...
export function ListingsCard({ id, title, src, url, description, viewHref, editHref, status, mutate }) {
  ...
  return (
    <Card key={id} className="max-w-2xl min-h-70">
      <div className="aspect-square rounded-t-lg ">
        <Image src={src} alt={`${title} Image`} width={500} height={500} className="rounded-t-lg w-full h-full object-cover" />
      </div>

...
export function BusinessBank({ ispending, formData, handleInputChange, handleSubmitBank }) {
   const location = useGeoLocation();
   const [banks, setBanks] = useState([]);

   useEffect(() => {
      const fetchPaystackBanksPerCountryName = async () => {
         const response = await fetch(`https://api.paystack.co/bank?country=${location?.country || "nigeria"}`, {
            headers: {

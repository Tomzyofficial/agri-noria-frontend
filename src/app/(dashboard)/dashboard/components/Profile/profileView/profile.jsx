...
export function VendorProfilePage({ rows, license_status, id_front_status, id_back_status, is_verified, initialVendor, initialProfileImg }) {
   ...
   const { isLoading: ratingsLoading, data: ratingsData, error: ratingsError } = useSWR("/api/proxy/vendor/product-ratings", fetcher);
   ...
   useEffect(() => {
      if (ratingsData?.success && ratingsData?.data) {
         setRatings({
            ...
            breakdown: ratingsData.data.breakdown || {
               5: 0,
               4: 0,
               3: 0,
               2: 0,
         ...
         <main className="my-25 lg:my-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
               ...
               <div className="lg:col-span-2 space-y-8">
                  ...
                  <ProfileInfoCard is_verified={is_verified} vendor={vendor} loading={loading} imageSrc={imageSrc} setOpenModal={setOpenModal} handleProfileImageChange={handleProfileImageChange} />
               ...
               <div className="lg:col-span-1 space-y-8">
                  ...
                  <KycVerification is_verified={is_verified} rows={rows} license_status={license_status} id_front_status={id_front_status} id_back_status={id_back_status} />

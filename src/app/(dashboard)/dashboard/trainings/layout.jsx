...
export default function DashboardLayout({ children }) {
   ...
   const sidebarNavMenu = [
      { label: "Overview", href: "/dashboard/trainings", icon: <LayoutDashboard className="w-4 h-4" /> },
      {
         label: "Create Training",
         href: "/dashboard/trainings/create-training",
         icon: <Calendar className="w-4 h-4" />,
      },
      { label: "Upload Material", href: "/dashboard/trainings/upload-material", icon: <Play className="w-4 h-4" /> },
      { label: "Profile", href: "/dashboard/trainings/profile", icon: <UserPen className="w-4 h-4" /> },
      { label: "Billing", href: "/dashboard/sub-store/billing", icon: <CreditCard className="w-4 h-4" /> },
      { label: "Ads", href: "/dashboard/ads", icon: <Megaphone className="w-4 h-4" /> },
   ];

   const navLinksStyle = (path) => {
      const active = path === pathname || (path === "/dashboard/ads" && pathname.startsWith("/dashboard/ads"));
      return active

...
export default function SalesLayout({ children }) {
   ...
   const sidebarNavMenu = [
      { label: "Overview", href: "/dashboard/sales-&-distribution", icon: <LayoutDashboard className="w-4 h-4" /> },
      { label: "Shipments", href: "/dashboard/sales-&-distribution/shipments", icon: <Truck className="w-4 h-4" /> },
      {
         label: "Warehouse",
      ...
      { label: "Settings", href: "/dashboard/sales-&-distribution/settings", icon: <Settings className="w-4 h-4" /> },
   ];

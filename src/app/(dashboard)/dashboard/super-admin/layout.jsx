...
export default function SuperAdminLayout({ children }) {
  ...
  const navMenu = [
    ...
    },
    {
      ...
      href: "/dashboard/super-admin/wallet",
      icon: <Wallet className="w-4 h-4" />,
    },
    {
      label: "Ecosystem Buyers",
      href: "/dashboard/super-admin/ecosystem-buyers",
  ...
  return (
    <div className="flex min-h-screen bg-(--background)">
      <aside>
        ...
        <div
          className={`${menuOpen && "left-0 w-64 h-full bg-[#fafafa] shadow shadow-md"} transition-all duration-300 fixed z-1 -left-64 top-0 lg:left-0 lg:w-64 lg:h-screen dark:bg-(--card-dark) dark:text-(--foreground) lg:bg-[#fafafa] lg:shadow lg:shadow-md p-2`}
        >
          <nav

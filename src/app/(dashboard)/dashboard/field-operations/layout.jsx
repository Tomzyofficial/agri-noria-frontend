...
export default function FieldOperationsLayout({ children }) {
   ...
   const navMenu = [
      { label: "Overview", href: "/dashboard/field-operations", icon: <LayoutDashboard className="w-4 h-4" /> },
      {
      ...
      { label: "Visit Schedule", href: "/dashboard/field-operations/schedule", icon: <Calendar className="w-4 h-4" /> },
      { label: "My Wallet", href: "/dashboard/field-operations/wallet", icon: <Wallet className="w-4 h-4" /> },
      { label: "Settings", href: "/dashboard/field-operations/settings", icon: <Settings className="w-4 h-4" /> },
   ];

   const navLinksStyle = (path) => {
      return path === pathname
         ? "bg-lime-100 text-lime-700 dark:bg-lime-900/30 dark:text-lime-400 p-2 rounded shadow-sm border-l-4 border-lime-600"
         ...
         <aside>
            ...
            >
               <div className="mb-8 px-2">
                  <h2 className="text-xl font-black text-lime-600 tracking-tighter uppercase">AgriNoria</h2>
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Field Operations</p>
               </div>

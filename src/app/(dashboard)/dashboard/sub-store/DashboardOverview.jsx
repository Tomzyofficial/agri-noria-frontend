...
export function DashboardOverview({ user }) {
   ...
   const { data, error, isLoading } = useSWR("/api/proxy/vendor/storage/get-total-storage", fetcher);

   return (
      <div className="my-25 lg:my-5 dark:text-(--foreground)">
         <div className="flex flex-row items-center justify-between mb-8">
            <div>
               <h1 className="text-2xl lg:text-3xl font-bold text-(--foreground)">Storage Dashboard</h1>
         ...
         <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card className="px-4 py-6">
               ...
               <CardContent>
                  <p className="mb-4">Manage your storage facilities, inventory, and pricing all in one place.</p>
                  <Link
            ...
            <Card className="px-4 py-6">
               ...
               <CardContent>
                  <p className="mb-4">Do you have new storage facilities to add? Add them to your dashboard quickly.</p>
                  <Link

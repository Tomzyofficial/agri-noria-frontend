...
import { LogOut, X, Menu, LayoutDashboard, Users, CreditCard, BarChart3, Settings, Globe, Wallet, Package } from "lucide-react";
...
export default function AggregatorLayout({ children }) {
   ...
   const sidebarNavMenu = [
      ...
      { label: "Buyer Management", href: "/dashboard/aggregator/buyers", icon: <Users className="w-4 h-4" /> },
      { label: "Cluster Management", href: "/dashboard/aggregator/clusters", icon: <Users className="w-4 h-4" /> },
      { label: "Financing & Escrow", href: "/dashboard/aggregator/financing", icon: <CreditCard className="w-4 h-4" /> },
      { label: "Intervention Requests", href: "/dashboard/aggregator/inputs", icon: <Package className="w-4 h-4" /> },
      { label: "Marketplace Data", href: "/dashboard/aggregator/marketplace", icon: <BarChart3 className="w-4 h-4" /> },
      { label: "My Wallet", href: "/dashboard/aggregator/wallet", icon: <Wallet className="w-4 h-4" /> },
      { label: "Settings", href: "/dashboard/aggregator/settings", icon: <Settings className="w-4 h-4" /> },
   ];

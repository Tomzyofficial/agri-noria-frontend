...
export default function ProgramManagementLayout({ children }) {
   ...
   const navMenu = [
      { label: "Overview", href: "/dashboard/program-management", icon: <LayoutDashboard className="w-4 h-4" /> },
      {
         label: "Cluster Operations",
         href: "/dashboard/program-management/clusters",
         icon: <Users className="w-4 h-4" />,
      },
      {
         label: "Ecosystem Programs",
         href: "/dashboard/program-management/programs",
         icon: <Briefcase className="w-4 h-4" />,
      },
      {
         label: "Pending Approvals",
         href: "/dashboard/program-management/approvals",
         icon: <Network className="w-4 h-4" />,
      },
      {
         label: "Full Loop",
         href: "/dashboard/program-management/loop",
         icon: <BarChart3 className="w-4 h-4" />,
      },
      { label: "My Wallet", href: "/dashboard/program-management/wallet", icon: <Wallet className="w-4 h-4" /> },
      { label: "Settings", href: "/dashboard/program-management/settings", icon: <Settings className="w-4 h-4" /> },
   ];

   const navLinksStyle = (path) => {
      return path === pathname
         ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400 p-2 rounded shadow-sm border-l-4 border-amber-600"

...
export default function InstitutionLayout({ children }) {
   ...
   let navMenu = [
      { label: "Overview", href: "/dashboard/institution", icon: <LayoutDashboard className="w-4 h-4" /> },
      {
         label: "Programs",
      ...
      { label: "Risk Management", href: "/dashboard/institution/risk", icon: <ShieldAlert className="w-4 h-4" /> },
      { label: "My Wallet", href: "/dashboard/institution/wallet", icon: <Wallet className="w-4 h-4" /> },
   ];
   ...
   navMenu.push(
      { label: "Settings", href: "/dashboard/institution/settings", icon: <Settings className="w-4 h-4" /> },
   );
         ...
         <aside>
            ...
            >
               <div className="mb-8 px-2">
                  <h2 className="text-xl font-black text-blue-600 tracking-tighter uppercase">AgriNoria</h2>

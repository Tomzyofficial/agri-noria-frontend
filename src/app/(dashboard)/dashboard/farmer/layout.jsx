...
export default function FarmerLayout({ children }) {
   ...
   const navMenu = [
      { label: "Overview", href: "/dashboard/farmer", icon: <LayoutDashboard className="w-4 h-4" /> },
      { label: "Enrolled Programs", href: "/dashboard/farmer/programs", icon: <Sprout className="w-4 h-4" /> },
      { label: "Training Center", href: "/dashboard/farmer/training", icon: <GraduationCap className="w-4 h-4" /> },
      { label: "My Farm", href: "/dashboard/farmer/farm", icon: <Tractor className="w-4 h-4" /> },
      { label: "Marketplace", href: "/dashboard/farmer/marketplace", icon: <Store className="w-4 h-4" /> },
      { label: "Storage & Logistics", href: "/dashboard/farmer/logistics", icon: <Truck className="w-4 h-4" /> },
      { label: "Financing", href: "/dashboard/farmer/financing", icon: <CreditCard className="w-4 h-4" /> },
      { label: "My Wallet", href: "/dashboard/farmer/wallet", icon: <Wallet className="w-4 h-4" /> },
      { label: "Settings", href: "/dashboard/farmer/settings", icon: <Settings className="w-4 h-4" /> },
   ];
            ...
            <aside>
               ...
               >
                  <div className="mb-8 px-2">
                     <h2 className="text-2xl font-black text-green-600 tracking-tighter uppercase">AgriNoria</h2>

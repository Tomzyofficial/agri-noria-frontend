...
import { LogOut, X, Menu, LayoutDashboard, Package2, UserPen, CreditCard, HandCoins, Globe } from "lucide-react";
...
export default function DashboardLayout({ children }) {
   ...
   const navMenu = [
      { label: "Overview", href: "/dashboard/store", icon: <LayoutDashboard className="w-4 h-4" /> },
      { label: "Products", href: "/dashboard/store/products", icon: <Package2 className="w-4 h-4" /> },
      { label: "Profile", href: "/dashboard/store/profile", icon: <UserPen className="w-4 h-4" /> },
      { label: "Loan Management", href: "/dashboard/store/loan", icon: <HandCoins className="w-4 h-4" /> },
      { label: "Billing", href: "/dashboard/store/billing", icon: <CreditCard className="w-4 h-4" /> },
   ];

...
export function useProductEditForm(product) {
   ...
   const handleSubmit = async (e) => {
      ...
      try {
         ...
         // Include existing image URL for reference if no new image
         if (formData.product_image === product.product_image) {
            formDataToSend.append("existing_image_url", product.product_image);
         }

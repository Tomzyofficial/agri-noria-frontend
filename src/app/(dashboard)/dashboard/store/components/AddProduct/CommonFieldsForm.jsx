...
// import ImageUpload from "@/app/(dashboard)/dashboard/store/components/AddProduct/not-in-use-ImageUpload";
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="col-span-2">
        ...
        <Textarea
          id="description"
          name="description"
          placeholder="Enter description, clearly describe the product..."
      ...
      <div className="col-span-2 border border-(--greenish-color) p-4 rounded-lg">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="">
            <Label>
              Buy at least {formData.min_quantity ? formData.min_quantity : "X"}{" "}
              item(s)
            </Label>
            <Input
              type="text"
          ...
          <div>
            <Label>
              get {formData.discount ? formData.discount : "Y"}% off
            </Label>
            <Input
              type="text"
              name="discount"
        ...
        <p className="text-sm text-gray-500 py-2">
          Discount applies when customer buys this quantity or more.
        </p>
      </div>
    </div>
  );

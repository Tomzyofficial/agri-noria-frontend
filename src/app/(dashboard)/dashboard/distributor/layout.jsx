...
export default function DistributorLayout({ children }) {
   ...
   const navMenu = [{ label: "Deliveries", href: "/dashboard/distributor", icon: <Truck className="w-4 h-4" /> }];
         ...
         <aside>
            ...
            >
               <div className="flex items-center gap-2 mb-8 mt-4 px-2">
                  ...
                  <h2 className="font-bold text-xl text-gray-900 dark:text-white tracking-tight">Distributor</h2>
               </div>

        ...
        {currentStep === 1 && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input name="category" autoComplete="on" id="category" type="text" value={formData.category} onChange={handleChange} placeholder="e.g. Poultry Construction, Fish Farming..." className="w-full border p-2 rounded" required />
        ...
        {currentStep === 4 && (
          <div className="space-y-4">
            <div>
              ...
              <Input id="featured_image" type="file" accept="image/*" onChange={handleFeaturedImageChange} className="w-full border p-2 rounded" required />

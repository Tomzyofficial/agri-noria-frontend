         ...
         <section className="grid lg:grid-cols-3 gap-6 my-10">
            ...
            <Card className="rounded-2xl py-2">
               ...
               <CardContent className="space-y-3 flex flex-col">
                  <Link className="hover:underline" href="/marketplace/farm-development/listings">
                     Manage Listings
                  </Link>
                  <Link className="hover:underline" href="/marketplace/farm-development/portfolio/create">
                     Add Portfolio Project
                  </Link>
                  <Link href="/marketplace/farm-development/listings/create" className="hover:underline " variant="outline">
                     Create New Listing
                  </Link>
                  <Link href="/marketplace/farm-development/quote-requests" className="hover:underline " variant="outline">

...
import ListingsTable, { ListingsMobile } from "./ListingsView";
    ...
    <div className="my-25 lg:my-5">
      ...
      <div className="">
        {listingsLoading ? (
          ...
          //     <Card key={listing.id} className="hidden md:block max-w-2xl min-h-70">
          ...
          <>
            <ListingsTable listings={filteredListings} isDeleting={isDeleting} onDelete={handleDelete} viewHref={(id) => `/marketplace/farm-development/listings/${id}/view`} editHref={(id) => `/marketplace/farm-development/listings/${id}/edit`} />

            <ListingsMobile listings={filteredListings} isDeleting={isDeleting} handleActionClick={handleActionClick} openActionId={openActionId} onDelete={handleDelete} viewHref={(id) => `/marketplace/farm-development/listings/${id}/view`} editHref={(id) => `/marketplace/farm-development/listings/${id}/edit`} />
          </>
        )}
      </div>
    </div>

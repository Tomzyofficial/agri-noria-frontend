      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
         <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 flex items-center justify-between border-b px-6 py-4 bg-white dark:bg-gray-800">
               ...
               <button type="button" onClick={handleClose} className="p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700" aria-label="Close">
                  <X className="w-5 h-5" />
               </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
               ...
               <div className="space-y-4">
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white ${validationErrors.assigned_driver_name ? "border-red-500" : "border-gray-300"}`}
                        disabled={loading}
                     />
                     {validationErrors.assigned_driver_name && <p className="mt-1 text-sm text-red-500">{validationErrors.assigned_driver_name}</p>}
                  </div>
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white ${validationErrors.assigned_driver_phone ? "border-red-500" : "border-gray-300"}`}
                        disabled={loading}
                     />
                     {validationErrors.assigned_driver_phone && <p className="mt-1 text-sm text-red-500">{validationErrors.assigned_driver_phone}</p>}
                  </div>
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white ${validationErrors.vehicle_plate_number ? "border-red-500" : "border-gray-300"}`}
                        disabled={loading}
                     />
                     {validationErrors.vehicle_plate_number && <p className="mt-1 text-sm text-red-500">{validationErrors.vehicle_plate_number}</p>}
                  </div>
               </div>
               ...
               <div className="space-y-4">
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white ${validationErrors.estimated_delivery_datetime ? "border-red-500" : "border-gray-300"}`}
                        disabled={loading}
                     />
                     {validationErrors.estimated_delivery_datetime && <p className="mt-1 text-sm text-red-500">{validationErrors.estimated_delivery_datetime}</p>}
                  </div>
               ...
               <div className="space-y-4">
                  ...
                  <div>
                     ...
                     <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-green-500 dark:hover:border-green-500 transition-colors">
                        <div className="space-y-1 text-center">
                           {previewUrl ? (
                              <div>
                                 <Image src={previewUrl} alt="Pickup preview" className="mx-auto h-48 w-auto object-cover rounded-lg" width={192} height={192} />
                                 <button
                                    type="button"
                                    onClick={() => {
                                       setPickupPhoto(null);
                              ...
                              <>
                                 ...
                                 <div className="flex justify-center text-sm text-gray-600 dark:text-gray-400">
                                    <label htmlFor="pickup_photo" className="relative cursor-pointer rounded-lg focus-within:outline-none focus-within:ring-2 focus-within:ring-green-500 focus-within:ring-offset-2 hover:text-green-500">
                                       <span>Upload a file</span>
                                       <input id="pickup_photo" name="pickup_photo" type="file" accept="image/jpeg,image/jpg,image/png,image/webp" onChange={handlePhotoChange} className="sr-only" disabled={loading} />
                                    </label>
                  ...
                  <div className="flex items-start">
                     <div className="flex items-center h-5">
                        <input id="pickup_confirmation" name="pickup_confirmation" type="checkbox" checked={formData.pickup_confirmation} onChange={handleInputChange} className={`w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-green-500 ${validationErrors.pickup_confirmation ? "border-red-500" : ""}`} disabled={loading} />
                     </div>
                     <div className="ml-3 text-sm">
                        ...
                        {validationErrors.pickup_confirmation && <p className="mt-1 text-sm text-red-500">{validationErrors.pickup_confirmation}</p>}
                     </div>
                  </div>
               </div>
               ...
               <div className="flex justify-end gap-3 pt-4 border-t">
                  <button type="button" onClick={handleClose} className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-green-500" disabled={loading}>
                     Cancel
                  </button>
                  <SubmitButton loading={loading} text="Start Shipment" loadingText="Processing" />
                  {/* <button
              type="submit"
              disabled={loading}

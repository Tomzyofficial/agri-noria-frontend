    ...
    <div className="my-25 lg:my-5 dark:text-(--foreground)">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <Card className="px-4 py-6">
          ...
          <CardContent>
            <p className="mb-4">
              Manage your product listings, inventory, and pricing all in one
              place.
            </p>
            <Link
              href="/marketplace/store/products"
        ...
        <Card className="px-4 py-6">
          ...
          <CardContent>
            <p className="mb-4">
              Do you have fresh produce ready? Add it to your marketplace
              quickly.
            </p>
            <Link

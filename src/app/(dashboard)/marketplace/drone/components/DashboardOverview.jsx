         ...
         <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card className="px-4 py-6">
               ...
               <CardContent>
                  ...
                  <Link href="/marketplace/drone/inventory" className="flex items-center justify-center group hover:bg-(--dark-green-color) focus:bg-(--dark-green-color) bg-(--greenish-color) transition transition-background text-(--gray-color) rounded-md p-2">
                     Manage Products
            ...
            <Card className="px-4 py-6">
               ...
               <CardContent>
                  ...
                  <Link href="/marketplace/drone/inventory/add-new" className="flex items-center justify-center hover:bg-(--dark-green-color) hover:text-(--white-fff) bg-gray-200 focus:bg-(--dark-green-color) transition transition-background text-black rounded-md p-2">

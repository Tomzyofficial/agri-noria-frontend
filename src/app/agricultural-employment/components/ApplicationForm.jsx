...
export default function ApplicationForm({ id }) {
   ...
   const onSubmit = async (data) => {
      ...
      try {
         ...
         reset();
         router.push("/agricultural-employment");
      } catch (error) {
         console.error(error);
      ...
      <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="space-y-6 rounded-xl border p-6">
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
               ...
               <PhoneInput id="phone" disabled={loading} className="phone-input disabled:opacity-50" {...register("phone")} placeholder="Enter phone number" />
            </div>

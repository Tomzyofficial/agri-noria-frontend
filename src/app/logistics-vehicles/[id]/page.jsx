...
export default async function Page({ params }) {
   ...
   const res = await fetch(apiUrl(`/api/vendor/logistics/public/vehicles?vehicleId=${id}`), {
      method: "GET",
      cache: "no-store",
   });
   ...
   vehicleData = vehcileResult.vehicleDetails ? vehcileResult.vehicleDetails : null;
